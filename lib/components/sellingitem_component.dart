...
class _SellingItemsv2State extends State<SellingItemsv2> with Navigations{
  ...
  Widget build(BuildContext context) {
    ...
    Features.btobModule?(deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 70:(deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 170;
...
//                            if(varmemberprice.toString() == varmrp.toString())
                              ...
                              if(Features.netWeight && widget._itemdata.vegType == "fish")
                                Container(
                                  width: (MediaQuery
                                      .of(context)
                                      .size
                        ...
                        /*            Navigator.of(context).pushNamed(
                                    ...
                                    Navigation(context, name: Routename.SubscribeScreen, navigatore: NavigatoreTyp.Push,
                                        qparms: {
                                          ...
                                          "varname": widget._itemdata.priceVariation![itemindex].variationName!+widget._itemdata.priceVariation![itemindex].unit!,
                                          "varmrp":widget._itemdata.priceVariation![itemindex].mrp,
                                          "varprice":  store.userData.membership! == "1" ? widget._itemdata.priceVariation![itemindex].membershipPrice.toString() :widget._itemdata.priceVariation![itemindex].discointDisplay! ?widget._itemdata.priceVariation![itemindex].price.toString():widget._itemdata.priceVariation![itemindex].mrp.toString(),
                                          "paymentMode": widget._itemdata.paymentMode,
                                          "cronTime": widget._itemdata.subscriptionSlot![0].cronTime,
                                          "name": widget._itemdata.subscriptionSlot![0].name,
                                          "varid":widget._itemdata.priceVariation![itemindex].id,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      // padding:EdgeInsets.only(left:55,right:55),
                                        height: 30.0,
                                        width: (widget._fromScreen == "brands_screen" || widget._fromScreen == "sellingitem_screen" || widget._fromScreen == "shoppinglistitem_screen" ||
                                            widget._fromScreen == "home_screen" ||widget._fromScreen == "search_item" || widget._fromScreen=="not_product_screen")?(MediaQuery.of(context).size.width / 5.8):
                           ...
                           // mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                              Expanded(
                                child: SizedBox(
                                   // height: 90.0,
                                    // width: Vx.isWeb?(widget._fromScreen == "sellingitem_screen" || widget._fromScreen == "search_item")?
                                    // (MediaQuery.of(context).size.width / 5.5):
                                    // (MediaQuery.of(context).size.width / 6.9):
                                    // (MediaQuery.of(context).size.width / 5.5),
                                    child: CustomeStepper(priceVariation: widget._itemdata.priceVariation![itemindex],itemdata: widget._itemdata,from: "selling_item",checkmembership:_checkmembership,alignmnt: StepperAlignment.Vertical,height: (Features.isSubscription)?90:60,)),
                              ),
                            ],
                          ),
                        ],
          ...
          if(widget._fromScreen == "sellingitem_screen") {
            ...
            if (widget._itemdata.priceVariation![itemindex].stock !>= 0)
             ...
             /* navigatetoSingelproductscreen(context,widget.returnparm,
                  ...
                  imageUrl: widget._itemdata.itemFeaturedImage,
                  itemvarData:itemvarData,
                  title:widget._itemdata.itemName,notid: widget._notid, );*/
              Navigation(context, name: Routename.SingleProduct, navigatore: NavigatoreTyp.Push,parms: {"varid": widget._itemdata.priceVariation![itemindex].id.toString()});
          }
        },
        child: Container(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Container(
                                    child: Text("Gross Weight:" +" "+
                                        widget._itemdata.priceVariation![itemindex].weight!,
                                        style: new TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 11 : ResponsiveLayout.isMediumScreen(context) ? 12 : 16, fontWeight: FontWeight.bold)
                                    ),
                                  ),
                                  Container(
                                    child: Text("Net Weight:" +" "+
                                        widget._itemdata.priceVariation![itemindex].netWeight!,
                                        style: new TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 11 : ResponsiveLayout.isMediumScreen(context) ? 12 : 16, fontWeight: FontWeight.bold)
                                    ),
                                  ),
                    ...
                    children: [
                      SizedBox(
                              ...
                              (MediaQuery
                                  ...
                                  .width /2) +
                                  67,
                              child: CustomeStepper(priceVariation: widget._itemdata.priceVariation![itemindex],itemdata: widget._itemdata,alignmnt: StepperAlignment.Horizontal,height:(Features.isSubscription)?90:60)),
